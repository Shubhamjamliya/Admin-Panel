...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API delay
    setTimeout(() => {
      // Create a fake JWT token with an expiry far in the future
      const fakeToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjI1Mjc1MzYwMDB9.signature";
      const fakeAdminData = JSON.stringify({
        id: "mock-id-123",
        name: "Admin Demo",
      ...
      // Set fake auth data in localStorage
      localStorage.setItem('adminAccessToken', fakeToken);
      localStorage.setItem('adminRefreshToken', 'fake-refresh-token');
      localStorage.setItem('adminData', fakeAdminData);

      setIsLoading(false);
      toast.success('Login bypassed for Demo!');
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          >
            <h3 className="text-sm font-semibold mb-2" style={{ color: themeColors.button }}>Super Admin Credentials:</h3>
